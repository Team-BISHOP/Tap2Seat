    ...
    variants: {
      variant: {
        ...
        destructive:
          ...
          "border border-secondary/30 bg-transparent hover:bg-secondary/10 hover:text-secondary-glow hover:border-secondary/50 hover:shadow-accent-glow transition-all duration-300",
        secondary:
